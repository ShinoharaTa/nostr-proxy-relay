...
- `POST   /api/investigate`               Investigate events (queries upstream relays, analyses patterns; **stores nothing**, spec §5.16). Accepts hex / NIP-19 (nsec → 400); `refs` collects reactions, `until` paginates
